...
while (i<length(varargin))
  ...
  elseif (strcmpi(varargin{i},'dfS2'))
    ...
    fprintf(2,'Invalid call to MCMC_diploid. The correct usage is\n');
    fprintf(2,'  MCMC_diploid(sourcepath,datapath,mcmcpath,xPop,yPop,...)');
  end
  i = i + 1;
end
...
[Mstruct,Sstruct,Jindex] = suff_diploid_SNPs(datapath,Vcoord,Mstruct);
