...
function MCMC_microsats(sourcepath,datapath,mcmcpath,xPop,yPop,varargin)
...
opt = default_sats_params(sourcepath);
...
while (i<length(varargin))
  ...
  elseif (strcmpi(varargin{i},'negBiP'))
    ...
    fprintf(2,'Invalid call to MCMC_microsats. The correct usage is\n');
    fprintf(2,'  MCMC_microsats(sourcepath,datapath,mcmcpath,xPop,yPop,...)');
  end
  i = i + 1;
end
...
[Mstruct,Sstruct,Jindex] = suff_microsats(datapath,Vcoord,Mstruct);
